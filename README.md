...
### Preencha o seguinte template:
Para vagas que possuam link para se candidatar:
```
...
Para vagas que possuam e-mail para enviar currículo para se candidatar:
```
Nome da vaga
- Empresa: nome da empresa que está contratando
...
Caso tenha alguma dificuldade, procure uma das moderadoras do evento.